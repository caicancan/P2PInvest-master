...
public class UserInfoAcitvity extends BaseActivity {


    private static final int CAMERAA = 100;
    ...
    protected int getLayoutId() {
        return R.layout.activity_user_info_acitvity;
    }


    @OnClick({R.id.textView1, R.id.loginout, R.id.iv_top_back})
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                switch (which) {
                                    case 0: // 拍照
                                        ...
                                        startActivityForResult(camera, CAMERAA);
                                        break;
                                    case 1: // 图库
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERAA && resultCode == RESULT_OK && data != null) {
            //拍照
